...
import { Card, CardBody, CardHeader, CardTitle, Table, Row, Col, Button, Modal, ModalHeader, ModalBody} from "reactstrap";
                        ...
                        <Col xs={12}>
                            <Card>
                                <CardHeader>
                                    ...
                                    <Button color="danger" onClick={()=>this.setState({showAddModal : true})}>Add</Button>
                                </CardHeader>
                                <CardBody>
                                    <Table responsive>
                                        <thead>
