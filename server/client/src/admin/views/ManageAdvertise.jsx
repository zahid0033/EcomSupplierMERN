...
class ManageAdvertise extends Component {
  ...
  sendDelete = async (id) => {
    await axios
      .delete(`/api/advertise/delete/${id}`)
      .then((response) => {
          ...
          <tr key={key}>
            ...
            <td>
              <span
                ...
                onClick={() => this.onDelete(advertise.id)}
              >
  ...
  onSave = async () => {
    ...
    await axios
      .post(`/api/advertise/add`, dataPost, {
        config: { headers: { 'Content-Type': 'multipart/form-data' } },
      })
      .then((response) => {
        if (response.data.success === true) {
          Swal.fire('Added!', 'Advertise added Successfully.', 'success')
          this.loadAdvertise()
        } else {
                  ...
                  <div className='form-row'>
                    ...
                    <div className='form-group col-md-4'>
                      ...
                      >
                        ...
                        <option value='after-latest-products'>
                          After latest products
                        </option>
                        <option value='after-exclusive-products-left'>
                          After exclusive products left
                        </option>
                        <option value='after-exclusive-products-middle'>
                          After exclusive products middle
                        </option>
                        <option value='after-exclusive-products-right'>
                          After exclusive products right
                        </option>
                        <option value='after-featured-products'>
              ...
              <Card>
                ...
                <CardBody>
                  <Table responsive>
                    ...
                    <tbody>{this.renderAdvertise()}</tbody>
                  </Table>
                </CardBody>
              </Card>
            </Col>
