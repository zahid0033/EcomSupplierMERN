      ...
      return (
        <div className='item col-md-3' key={key}>
          <span
            ...
            onClick={() => this.zoomImageHandler(`${image}`)}
          >
            <img
                  ...
                  <div className='col-lg-6 col-md-6 mb-4 mb-md-0'>
                    <div className='product-image'>
                      ...
                      <div className='product_gallery_item'>
                        <div className='row'>{this.productImages()}</div>
                      </div>
                    </div>
                  </div>
                  <div className='col-lg-6 col-md-6'>
                    <div className='pr_detail'>
                      ...
                      <ul className='product-meta'>
                        <li>
                          Category:{' '}
                          <Link to={`/subCategory/${product.subCategory.id}`}>
                ...
                <div className='row'>
                  <div className='tab-style3'>
                    ...
                    >
                      <TabPane tabId='1'>
                        <Row>
                          <Col sm='12'>{parse(product.description)}</Col>
                        </Row>
                      </TabPane>
                      <TabPane tabId='2'>
                        <Row>
                          <Col sm='12'>{parse(product.specification)}</Col>
                        </Row>
                      </TabPane>
                    </TabContent>
                  </div>
