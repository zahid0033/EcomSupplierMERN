...
class SupplierAddOrEditProduct extends Component {
  ...
  loadSubCatg = () => {
    return this.state.subCategories.map((subCatg, key) => {
      return (
        <option value={subCatg.id} key={key}>
          {subCatg.name}
        </option>
      )
    })
  ...
  onSave = async () => {
    if (this.validator.allValid()) {
      ...
      if (!this.props.edit) {
        ...
        await axios
          .post(`/api/product/update/${this.props.singleData.id}`, dataPost, {
            config: { headers: { 'Content-Type': 'multipart/form-data' } },
          })
          .then((response) => {
            if (response.data.success === true) {
        ...
        <div>
          ...
          <div className='form-group'>
            ...
            <CKEditor
              ...
              data={
                this.props.edit
                  ? this.props.singleData.specification
                  : specification
              }
            />
          ...
          <div className='form-group'>
            ...
            <CKEditor
              ...
              data={
                this.props.edit
                  ? this.props.singleData.description
                  : description
              }
            />
            {this.validator.message(
